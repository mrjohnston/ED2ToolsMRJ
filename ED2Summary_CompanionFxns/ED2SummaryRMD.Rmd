...
#         ylim=c(min(mmean_carbon_ac),max(mmean_carbon_ac)),col=ycols)
     ...
     plot(subtimeslistyrs,mmean_carbon_ac,type="o",pch=20,xlab="month",ylab="MMEAN_CARBON_AC+PY [umol/m2/s]",
         ylim=c(min(mmean_carbon_ac),max(mmean_carbon_ac)))
...
if("I"%in%tscales){
 if(length(fileselec)!=0){
    ...
    plot(1:dataperday,cmat[,w],type="o",pch=20,col=colors[w],lty=lty[w],
         ylim=c(min(cmat),max(cmat)), xlab="",ylab="FMEAN_CARBON_AC [umol/m2/s]",
